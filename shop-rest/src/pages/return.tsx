...
import { returnc } from "@settings/return.setting";
...
export default function Returnc() {
  const { t } = useTranslation("returnc");
  const { title, date, content } = returnc;
...
Returnc.Layout = Layout;

export const getStaticProps = async ({ locale }: any) => {
  return {
    props: {
      ...(await serverSideTranslations(locale, ["common", "returnc"])),
    },
  };
};
