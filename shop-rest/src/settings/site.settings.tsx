...
export const siteSettings = {
  name: "Blackhound I Shoes-Ecommerce",
  description: "",
  logo: {
    url: "/logo.svg",
    alt: "Blackhound I Shoes-Ecommerce",
    href: "/shoes",
    width: 128,
    height: 80,
  },
  ...
  currencyCode: "INR",
  author: {
    name: "Blackhound | Shoes-Ecommerce",
    websiteUrl: "http://blackhound.com",
    address: "115, Lucknow, UP",
    phone: "+91 9917649167",
    social: [
      {
  ...
  headerLinks: [
    ...
    // { href: ROUTES.PRIVACY, icon: null, label: "text-policy" },
    // { href: ROUTES.TERMS, icon: null, label: "text-terms" },
